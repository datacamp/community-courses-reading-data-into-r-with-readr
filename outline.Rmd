...
* Saving a file
   ...
   * This is about twice as fast as `write.csv()`, and never writes row names. output_columnis a generic method used to coerce columns to suitable output.
   * `write_excel_csv()` ?