...
```{r}
library(readr)
download.file("http://s3.amazonaws.com/assets.datacamp.com/production/course_1561/datasets/Salaries.tsv", "Salaries.tsv")
...
```{r}
library(readr)
read_csv("http://s3.amazonaws.com/assets.datacamp.com/production/course_1561/datasets/chickwts.csv")
```
