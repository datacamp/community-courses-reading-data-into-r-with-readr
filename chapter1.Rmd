...
In this exercise, you’ll import a set of data on professors’ salaries called `Salaries.tsv` with `read_tsv()`, another `readr` function that imports TSV files. This time, you’ll also explore a couple of optional arguments.
